...
namespace XamlBindingInfo
{
    ...
    internal:
        ...
        virtual void VectorChanged_RoutesOverBingMapsApp_Waypoint(::Windows::Foundation::Collections::IObservableVector<::RoutesOverBingMapsApp::Waypoint^>^ sender, ::Windows::Foundation::Collections::IVectorChangedEventArgs^ e)
        {
            if (this->_pBindingsTrackingWeakRef)
            {
        ...
        void UpdateVectorChangedListener_RoutesOverBingMapsApp_Waypoint(::Windows::Foundation::Collections::IObservableVector<::RoutesOverBingMapsApp::Waypoint^>^ obj, ::Windows::Foundation::Collections::IObservableVector<::RoutesOverBingMapsApp::Waypoint^>^* pCache, ::Windows::Foundation::EventRegistrationToken* pToken)
        {
            if (*pCache != nullptr && !(*pCache)->Equals(obj))
            {
            ...
            {
                *pCache = obj;
                *pToken = obj->VectorChanged += ref new ::Windows::Foundation::Collections::VectorChangedEventHandler<::RoutesOverBingMapsApp::Waypoint^>(
                    this, &::XamlBindingInfo::XamlBindingTracking::VectorChanged_RoutesOverBingMapsApp_Waypoint);
            }
        }
        ...
        void UpdateVectorChangedListener_RoutesOverBingMapsApp_WayptInputComboOpt(::Windows::Foundation::Collections::IObservableVector<::RoutesOverBingMapsApp::WayptInputComboOpt^>^ obj, ::Windows::Foundation::Collections::IObservableVector<::RoutesOverBingMapsApp::WayptInputComboOpt^>^* pCache, ::Windows::Foundation::EventRegistrationToken* pToken)
        {
            ...
            {
                *pCache = obj;
                *pToken = obj->VectorChanged += ref new ::Windows::Foundation::Collections::VectorChangedEventHandler<::RoutesOverBingMapsApp::WayptInputComboOpt^>(
                    this, &::XamlBindingInfo::XamlBindingTracking::VectorChanged_RoutesOverBingMapsApp_WayptInputComboOpt);
            }
        }
    ...
    internal:
        ...
        static void Set_RoutesOverBingMapsApp_MyWaypointControl_ViewModel(::RoutesOverBingMapsApp::MyWaypointControl^ obj, ::RoutesOverBingMapsApp::Waypoint^ value, ::Platform::String^ targetNullValue)
        {
            if (value == nullptr && targetNullValue != nullptr)
            {
                value = (::RoutesOverBingMapsApp::Waypoint^) ::Windows::UI::Xaml::Markup::XamlBindingHelper::ConvertValue(::RoutesOverBingMapsApp::Waypoint::typeid, targetNullValue);
            }
            obj->ViewModel = value;
        }
